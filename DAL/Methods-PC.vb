...
Public Class Methods
    ...
    Public Function SelectPermissionsByUserId(ByVal U As User) As DataTable
        Dim comando As SqlDataAdapter = New SqlDataAdapter("SELECT IdUser, SoftwareStatus, Alarm, Fire, Message, LightBedR1, LightBedR2, LightBedR3, LightLiving, LightDining, LightGarage, TimeStamp FROM Status WHERE IdUser = " + U.IdUser, conn)
        Dim tabela As DataTable = New DataTable()
        comando.Fill(tabela)
        Return tabela
    End Function
